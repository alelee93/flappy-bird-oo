...
const obstaculos = {
  ...
  dibujar: function (parObstaculos) {
    ...
    parObstaculos.topObstacle.style.height = parObstaculos.topObstacleHeight + "px";
    parObstaculos.bottomObstacle.style.height = parObstaculos.bottomObstacleHeight + "px";
  },
};
